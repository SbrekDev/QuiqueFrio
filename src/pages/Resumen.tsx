  ...
  return (
    <div className="flex justify-center items-center mx-auto">
        <div className="container grid grid-cols-6 grid-rows-8 gap-5 w-[600px] xl:w-[800px] 2xl:w-[900px] h-[670px]">
          <Link to='/clientes' 
            className="col-span-3 row-span-3 rounded-lg shadow-lg bg-gradient-to-r from-primary to-secondary hover:scale-105 transition-all flex flex-col justify-center items-center p-5"
            >
          ...
          <Link to='/administrar-ingresos'
            className="col-span-3 xl:col-span-4 row-span-3 rounded-lg shadow-lg bg-gradient-to-r from-primary to-secondary hover:scale-105 transition-all flex flex-col justify-center items-center p-5"
            >
          ...
          <Link to='/administrar-ingresos'
            className="col-span-3 xl:col-span-2 row-span-3 rounded-lg shadow-lg bg-gradient-to-r from-primary to-secondary hover:scale-105 transition-all flex flex-col justify-center items-center p-5"
            >
          ...
          <Link to='/administrar-ingresos'
            className="col-span-6 row-span-2 rounded-lg shadow-lg bg-gradient-to-r from-primary to-secondary hover:scale-105 transition-all flex justify-center items-center p-5 gap-24"
            >
        ...
        <button 
        className="absolute right-10 bottom-10 bg-primary p-4 text-white font-bold uppercase hover:bg-hover cursor-pointer rounded-full shadow-lg transition-colors flex items-center justify-center gap-3"
        onClick={handleReset}
