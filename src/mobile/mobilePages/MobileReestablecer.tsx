  ...
  return (
    <div className="flex justify-center items-center mx-auto h-full w-full p-2">
      <div className="bg-white shadow-lg rounded-lg p-10 space-y-16 w-full">
        <h2 className="text-3xl font-bold text-center text-slate-700">Seleccione el archivo de la última <span className="text-primary">Copia de Seguridad</span></h2>
        <div className="flex flex-col space-y-4">
          ...
          <input type="submit" 
            value='Reestablecer' 
            className="bg-primary w-full p-3 text-white font-bold uppercase hover:bg-hover cursor-pointer rounded transition-colors mt-5"
